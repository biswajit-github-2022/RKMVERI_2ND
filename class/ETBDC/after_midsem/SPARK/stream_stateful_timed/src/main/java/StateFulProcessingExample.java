...
public class StateFulProcessingExample {
	public static void main(String[] args) throws InterruptedException {
		...
		SparkSession sparkSession = SparkSession.builder().master("local[*]").appName("Stateful Streaming Example").getOrCreate();
...
System.out.println("See the params\n");
System.out.println(curFlightDetail.get().getTemperature());
System.out.println(curFlightDetail.get().getFlightId());
